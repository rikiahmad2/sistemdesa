                ...
                <tbody>
                    ...
                    foreach ($data as $row) {
                           ...
                           echo'<tr>
                            ...
                            echo'<a type="submit" name="edit_kk" href="'.base_url("Admin/sEditKepala/".$row->no_kk."/".$row->nik."").'" data-toggle="tooltip" title="Jadikan Kepala Keluarga" class="btn btn-effect-ripple btn-default"><i class="fa fa-cube"></i></a>';
                            ...
                            echo '</form>
                                ...
                                <td class="text-center" width="200px">
                                    ...
                                    <a href="'.base_url("Admin/editPenduduk/".$row->nik."").'" data-toggle="tooltip" title="Edit" class="btn btn-effect-ripple btn-success"><i class="fa fa-pencil"></i></a>
                                    <a href="'.base_url("Admin/hapusPenduduk/".$row->nik."/".$aksi."").'" class="btn btn-effect-ripple btn-danger"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>';
                        $i++;
                    }
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form-validation" action="<?=base_url('Admin/sTambahPenduduk')?>" method="POST" enctype="multipart/form-data">
