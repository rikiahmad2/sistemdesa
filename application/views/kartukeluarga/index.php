...
<div id="page-content">
    ...
    <div class="block full">
        <div class="block-title">
            <h2><i class="fa fa-list sidebar-nav-icon"></i> Kartu Keluarga</h2>
        </div>
        <a href="#modal-fade" title="Tambah Agama" class="btn btn-effect-ripple btn-info" data-toggle="modal"><i class="fa fa-plus"></i> Tambah Kartu Keluarga</a>
        <br>
        <br>
                ...
                <?php
                    ...
                    echo'<span class="label label-warning">
                            ...
                            <td class="text-center">
                                <a href="'.base_url("Admin/detailKk/".$row->no_kk."").'" data-toggle="tooltip" title="Detail" class="btn btn-effect-ripple btn-warning"><i class="fa fa-search"></i></a>
                                <a href="'.base_url("Admin/editKk/".$row->no_kk."").'" class="btn btn-effect-ripple btn-success"><i class="fa fa-pencil"></i></a>
                                <a href="'.base_url("Admin/hapusKk/".$row->no_kk."").'" class="btn btn-effect-ripple btn-danger"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>';
                        $i++;
                    }
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?=base_url('Admin/sKartuKeluarga') ?>" method="post" class="form-bordered">
                            <div class="form-group">
                                <label>ID KK</label>
                                <input type="text" name="id_kk" class="form-control" value="<?=$id['id_new']; ?>" readonly>
                            </div>
                            <div class="form-group">
                                <label>No KK</label>
