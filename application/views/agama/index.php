            ...
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                ...
                <?php
                    ...
                    echo '<tr>
                            ...
                            <td><strong>'.$row->nama_agama.'</strong></td>
                    ...
                    echo'<span class="'.$klas.'">
                            ...
                            <td class="text-center">
                                <a href="'.base_url("Admin/edit_agama/".$row->id_agama."").'" class="btn btn-effect-ripple btn-success"><i class="fa fa-pencil"></i></a>
                                <a href="'.base_url("Admin/hapus/".$row->id_agama."").'" class="btn btn-effect-ripple btn-danger"><i class="fa fa-times"></i></a>
                            </td>
                        </tr>';
                        $i++;
                    }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?=base_url('Admin/submit_tambah')?>" method="post" class="form-bordered">
                    <div class="form-group">
                        <label>ID Agama</label>
                        <input type="text" name="id_agama" class="form-control" value="A<?=$i?>" readonly>
                    </div>
                    <div class="form-group">
