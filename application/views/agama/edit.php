...
<div id="page-content">
    ...
    <div class="col-md-8">
        <div class="block">
            ...
            <form action="<?=base_url('Admin/sEditAgama/'.$data['id_agama'].'')?>" method="post" class="form-horizontal form-bordered">
                <div class="form-group">
                    <input type="hidden" name="id_agama" value="asd">
                    <label class="col-md-3">Nama Agama</label>
                    <div class="col-md-8">
                        <input type="text" name="nama_agama" class="form-control" placeholder="Nama Agama" value="<?=$data['nama_agama'] ?>">
                    </div>
                </div>
